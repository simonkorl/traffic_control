...
def tc_easy_bandwith(**kwargs):
    ...
    os.system("tc class {0} dev {2} parent 1: classid 1:11 htb rate {1}mbit ceil {1}mbit".format(op_mode, bw, nic_name))
    if kwargs['first']:
        os.system("tc filter add dev {0} protocol ip parent 1:0 prio 1 u32 match ip dport 0 0x0000 flowid 1:11".format(nic_name))
